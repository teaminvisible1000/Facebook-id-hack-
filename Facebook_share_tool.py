# Gift By : Team invisible
# Github : https://github.com/🌺🌺
# Fb Id    : Hdr Antu chowdhury
###----------[ IMPORT LIBRARY ]---------- ###
...
def logo_menu():
 ...
 /_/ \_\___/  |_| \___/  |___/_||_/_/ \_\_|_\___|'''
    cetak(
        nel(banner, title=f'{P2} {K2}[ {H2}A{H2}N{H2}T{H2}U{H2} {H2}  {B2}{B2}{B2}{B2}{K2}{K2}{K2}{K2}{K2} {H2}]',
...
def login():
    os.system("clear")
    print("""
  \033[35;1m   ___      .__   __. .___________. __    __  
  \033[35;1m  /   \     |  \ |  | |           ||  |  |  | 
   \033[35;1m/  ^  \    |   \|  | `---|  |----`|  |  |  | 
  \033[35;1m/  /_\  \   |  . `  |     |  |     |  |  |  | 
 \033[35;1m/  _____  \  |  |\   |     |  |     |  `--'  | 
\033[35;1m/__/     \__\ |__| \__|     |__|      \______/  
 \033[35;1m                                                                                                                                                                            
    ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
    ║\33[0;41m           [ ENJOY FB AUTO SHARE ]           \033[0;92m║
    ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
    \33[1;32m====================================================
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;92mAntu chowdhury
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;93mHdr Antu chowdhury
    \033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;94m🌺🌺🌺🌺🌺🌺
    ...
    \33[1;32m====================================================
    """)
    cetak(nel(f'\n \t {H2}  FB AUTO SHARE TOOLS BRO \n\n \t\t {H2}~[{K2} A{K2}N{K2}T{K2}U{K2}{K2}  {H2}]~',
              title=f'{P2}  {H2}[{K2} A{K2}N{K2}T{K2}U{K2}{K2}  {K2}T{K2}E{K2}R{K2}M{K2}U{K2}X {K2}H{K2}E{K2}L{K2}P{K2}I{K2}N{K2}G {K2}Z{K2}O{K2}N{K2}E {H2}]',
...
{B2} Current Date    :{H2} {hari}, {tanggal}''', title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}]',
    ...
    cetak(
        nel(f'{H2} A{H2}N{H2}T{H2}U{H2}{H2}  {B2}{B2} {O2}{O2}{O2}{O2} {N2}{N2}{N2}{N2}{N2} {K2}{K2}{K2}{K2}{K2}',
    ...
    try:
        ...
        for x in range(jumlah):
            ...
            if "id" in post:
                ...
                print(f'{P}\r   └──>{H} {bas} {K} A{K}N{K}T{K}U{K}{K}  SEND {H}[{n}]{P}{K} AUTO SHARE {H} SUCSSES{H} ',
                      end='');
                sys.stdout.flush()
            else:
                print("\n")
